...
Scriptname MEKCHMTIF__06000AA6 Extends TopicInfo Hidden
...
Game.GetPlayer().AddSpell(MEKCHMSummonChairHorseSpell)
...
Spell Property MEKCHMSummonChairHorseSpell Auto
